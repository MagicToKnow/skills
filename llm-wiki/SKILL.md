...
All generated content — including entity pages, ref summaries, index entries, synthesis pages, lint reports, file names (page slugs, ref IDs, raw filenames), `schema.md` configuration, and any user-facing output — must use **Chinese (Simplified)** as the primary language, except:
